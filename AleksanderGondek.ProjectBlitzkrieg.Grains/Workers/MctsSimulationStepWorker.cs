...
{
    public class MctsSimulationStepWorker : Grain, IMctsSimulationStepWorker
    {
        ...
        public Task<bool> PerformSimulation(ProcessingRequest request)
        {
            Initialize();
            
            var playout = new SimulationOnlyPlayout<MctsNode, ChessGameState>()
            {
            ...
            return Task.FromResult(playout.PerformSimulation());
        }
    }
}